...
export class Convert {
    public static toParks(json: string): Coords {
        return cast(JSON.parse(json), r("Parks"));
    }

    public static parksToJson(value: Coords): string {
...
const typeMap: any = {
    ...
    "Location": o([
        { json: "referencePosition", js: "referencePosition", typ: r("ReferencePosition") },
